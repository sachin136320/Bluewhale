...
const tablecolumns = [
    { title: 'Visitor Parking', field: 'name', editable: 'onUpdate' },
    { title: 'Available', field: 'surname', editable: 'never' },
    { title: 'Booked', field: 'flatNumber', type: 'text' },
    {
        title: 'Block',
        field: 'block',
...
export default function BookVisitorParking() {
